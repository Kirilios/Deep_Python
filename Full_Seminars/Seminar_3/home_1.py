'''
На вход подается словарь со
списком вещей для похода в качестве ключа и их массой max_weight в качестве значения.
...
for key, value in items.items():
    if sum(backpack.values()) + value <= max_weight:
        backpack[key] = value
print(backpack)
