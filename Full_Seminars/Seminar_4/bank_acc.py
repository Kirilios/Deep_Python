...
кратна ли сумма amount заданному множителю MULTIPLICITY. Реализуйте
...
def exit():
    ...
    if bank_account > RICHNESS_SUM:
        ...
        bank_account -= tax
        operations.append(f'Вычтен налог на богатство {RICHNESS_PERCENT}% в сумме {tax} у.е. ' + \
...
# 'Пополнение карты на 500 у.е. Итого 999999999999940 у.е.', 'Снятие с карты 3000 у.е.
# Процент за снятие 45 у.е.. Итого 999999999996895 у.е.',
